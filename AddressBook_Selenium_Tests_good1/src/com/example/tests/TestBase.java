...
public class TestBase {
	...
	//нажатие на ссылку вернуться к группам group page
	...
	//заполнение всех полей на странице при создании группы
	...
	//нажатиe на создание новой группы Newgroupe
	protected void clicNewGroup() {
		driver.findElement(By.name("new")).click();
	}

	//нажатие на верхнюю вкладку группы
	...
	//нажатие на ссылку вернуться на Home Page
	protected void returnToHomePage() {
		driver.findElement(By.linkText("home page")).click();
	}
	
	//Сликаем на элемент нового контакта Add new
	public void clicAddNewContact() {
		driver.findElement(By.linkText("add new")).click();
	}

	//заполнение всех полей на странице (из базы данных Contactdata
	...
	//нажимаем на кнопку Enter (при создании Нового контакта)
